...
Projet de fin d'études **FISA4 — Big Data / IA / Web** réalisé à l'**ISEN Nantes** (2024-2025).

---

## Objectif

Moderniser la gestion des **12 000+ arbres** de la ville de Saint-Quentin en combinant cartographie interactive, base de données et modèles de Big Data. L'application permet de :
...
| Membre | Rôle |
|---|---|
| **Mélissa Bouanchaud** | BC1 — Clustering K-Means |
| **Ethan Heurtin** | BC2 — Random Forest Regressor (âge) |
| **Pierre Sicot** | BC3 — Random Forest Classifier (déracinement) + intégration web |
